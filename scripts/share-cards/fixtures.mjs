...
export const fixtures = [
  ...
  { id: 'spot-collage', rating: 4.8, kind: 'spot', label: 'Spot', title: 'Sihlcity Parkour Park', subtitle: 'Example training spot · Zürich', detail: 'Explore on PK Spot', photos: [photo, second, third] },
  ...
  { id: 'long-de', rating: 3.7, kind: 'spot', label: 'Spot', title: 'Ein besonders langer Name für einen Parkour-Spot am alten Güterbahnhof', subtitle: 'München, Deutschland', detail: 'Entdecke deinen nächsten Trainingsort', photos: [photo] },
];
