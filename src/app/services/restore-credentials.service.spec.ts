...
import { RESTORE_CREDENTIALS_ENABLED, RestoreCredentialsService } from "./restore-credentials.service";
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: RESTORE_CREDENTIALS_ENABLED, useValue: true },
        { provide: FunctionsAdapterService, useValue: functions },
      ],
    });
  });

  it("does not contact restoration services while the release gate is disabled", async () => {
    TestBed.overrideProvider(RESTORE_CREDENTIALS_ENABLED, { useFactory: () => false });
