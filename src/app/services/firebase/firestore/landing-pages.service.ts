  ...
  private _mapEventPreview(preview: CommunityEventPreviewSchema): PkEvent {
    return new PkEvent(
      ...
      this._assetUrls.resolveEventAssetUrls({
        ...
        logo_src: preview.logo_src,
        logo_fit: preview.logo_fit,
        logo_background_color: preview.logo_background_color,
        ...
        location_raw: preview.location_raw,
        bounds: preview.bounds,
        sponsor: preview.sponsor,
        is_promoted: preview.is_promoted ?? preview.is_sponsored,
        is_sponsored: preview.is_sponsored ?? preview.is_promoted,
