...
describe("Typesense events_v1 ↔ EventDiscoverySchema", () => {
  ...
  const mapping: CollectionMapping = {
    ...
    listing_tier: { kind: "direct", source: "listing_tier" },
    country_code: { kind: "direct", source: "country_code" },
    region_keys: { kind: "direct", source: "region_keys" },
    community_broadcast: {
      kind: "direct",
