...
describe("Typesense events_v1 ↔ EventDiscoverySchema", () => {
  ...
  const firestoreFields = [
    ...
    "featured_participants.name",
    "featured_participants.type",
    "featured_participants.role",
    "featured_participants.description",
    "featured_participants.url",
    "featured_participants.image_src",
    "venue_string",
    "locality_string",
    "location",
    "location_raw",
    ...
    "program.plans.items.series_memberships.qualification_paths",
    "program.plans.items.series_memberships.qualification_paths.id",
    "program.plans.items.series_memberships.qualification_paths.label",
    "program.plans.items.series_memberships.qualification_paths.label_i18n",
    "program.plans.items.series_memberships.qualification_paths.requirement_mode",
    "program.plans.items.series_memberships.qualification_paths.requirements",
    "program.plans.items.series_memberships.qualification_paths.requirements.kind",
    "program.plans.items.series_memberships.qualification_paths.requirements.event_id",
    "program.plans.items.series_memberships.qualification_paths.requirements.program_item_id",
    ...
    "series_memberships.qualification_paths",
    "series_memberships.qualification_paths.id",
    "series_memberships.qualification_paths.label",
    "series_memberships.qualification_paths.label_i18n",
    "series_memberships.qualification_paths.requirement_mode",
    "series_memberships.qualification_paths.requirements",
    "series_memberships.qualification_paths.requirements.kind",
    "series_memberships.qualification_paths.requirements.event_id",
    "series_memberships.qualification_paths.requirements.program_item_id",
  ...
  const firestoreFieldTypes = {
    ...
    "featured_participants.role": "string[]",
    "featured_participants.description": "string[]",
    "featured_participants.url": "string[]",
  ...
  const mapping: CollectionMapping = {
    ...
    "featured_participants.name": {
      kind: "direct",
      source: "featured_participants.name",
    },
    "featured_participants.type": {
      kind: "direct",
      source: "featured_participants.type",
    },
    "featured_participants.role": {
      kind: "direct",
      source: "featured_participants.role",
    },
    "featured_participants.description": {
      kind: "direct",
      source: "featured_participants.description",
    },
    "featured_participants.url": {
      kind: "direct",
      source: "featured_participants.url",
    },
    "featured_participants.image_src": {
      kind: "direct",
      source: "featured_participants.image_src",
    },
...
describe("Typesense communities_v1 ↔ CommunityPageSchema", () => {
  const firestoreFields = [
    ...
    "published",
    "merge_into",
    "merge_into.target_community_key",
    "merge_into.info_cards",
    "merge_into.status",
    "merge_into.requested_at",
    "merge_into.applied_at",
    "merge_into.error",
    "generatedAt",
    "sourceMaxUpdatedAt",
    "bounds_center",
  ...
  const mapping: CollectionMapping = {
    ...
    search_aliases: { kind: "direct", source: "search_aliases" },
    merged_community_keys: { kind: "direct", source: "merged_community_keys" },
    redirected_from_slugs: { kind: "direct", source: "redirected_from_slugs" },
    redirect_to_community_key: { kind: "direct", source: "redirect_to_community_key" },
    redirect_to_path: { kind: "direct", source: "redirect_to_path" },
